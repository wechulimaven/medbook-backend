...
from patients.serializers import PatientTableSerializer, PatientDetailUpdateSerializer
...
class UpdatePatientsDetailsView(APIView):
    serializer_class = PatientDetailUpdateSerializer
