...
class PatientTable(BaseModel):
    ...
    gender = models.OneToOneField(GenderTable, on_delete=models.CASCADE, blank=True, null=True)
    service = models.OneToOneField(GenderTable, on_delete=models.CASCADE, blank=True, null=True)
