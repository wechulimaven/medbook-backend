...
class PatientTable(BaseModel):
    ...
    gender = models.OneToOneField(GenderTable, on_delete=models.CASCADE, blank=True, null=True, unique=False)
    service = models.OneToOneField(ServicesTable, on_delete=models.CASCADE, blank=True, null=True, unique=False)
