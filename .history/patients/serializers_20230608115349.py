...
class PatientDetailUpdateSerializer(UserBaseSerializer):
    business_name = serializers.CharField(
        required=False, allow_blank=True, allow_null=True
    )
    business_primary_location = serializers.CharField(
        required=False, allow_blank=True, allow_null=True
    )
    ...
    # support_document = serializers.CharField(
    #     required=False, allow_blank=True, allow_null=True
    # )
    # id_front = serializers.CharField(
    #     required=False, allow_blank=True, allow_null=True
    # )
    # id_back = serializers.CharField(
    #     required=False, allow_blank=True, allow_null=True
    # )
